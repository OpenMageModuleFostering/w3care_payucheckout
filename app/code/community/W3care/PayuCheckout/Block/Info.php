...
class W3care_PayuCheckout_Block_Info extends Mage_Payment_Block_Info {

  /**
   * Set template for info block
   *
   */
	protected function _construct() {
    parent::_construct();
    $this->setTemplate('payucheckout/payment/info.phtml');
  }
