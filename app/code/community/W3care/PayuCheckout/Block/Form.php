...
/**
 * Payucheckout Form block
 *
 * @category    W3care
 * @package     W3care_PayuCheckout
 * @author	    W3care Developer <info@w3care.com>
 */
class W3care_PayuCheckout_Block_Form extends Mage_Payment_Block_Form
{
  /**
   * Set payment detail form for checkout
   *
   */
	protected function _construct()
  {	
 	  $this->setTemplate('payucheckout/payment/form.phtml');
    parent::_construct();
  }
}